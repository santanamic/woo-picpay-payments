 ...
 */
class LimitStream implements \_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
