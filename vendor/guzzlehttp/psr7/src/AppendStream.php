 ...
 */
class AppendStream implements \_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface $stream)
    {
