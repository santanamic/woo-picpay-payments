 ...
 */
class MultipartStream implements \_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PA88H63MC84HH6TR4VD\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PA88H63MC84HH6TR4VD\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
