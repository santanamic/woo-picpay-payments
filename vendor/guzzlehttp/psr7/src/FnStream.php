 ...
 */
class FnStream implements \_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PA88H63MC84HH6TR4VD\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
