    ...
    public function __invoke(\_PA88H63MC84HH6TR4VD\Psr\Http\Message\RequestInterface $request, array $options)
    {
        ...
        if (!$request->hasHeader('Content-Type')) {
            if ($uri = $request->getBody()->getMetadata('uri')) {
                if ($type = \_PA88H63MC84HH6TR4VD\GuzzleHttp\Psr7\mimetype_from_filename($uri)) {
        ...
        return $fn(\_PA88H63MC84HH6TR4VD\GuzzleHttp\Psr7\modify_request($request, $modify), $options);
    }
    private function addExpectHeader(\_PA88H63MC84HH6TR4VD\Psr\Http\Message\RequestInterface $request, array $options, array &$modify)
    {
